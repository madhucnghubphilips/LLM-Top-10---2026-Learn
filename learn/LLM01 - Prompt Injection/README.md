...
Hands-on Streamlit lab for OWASP LLM01: Prompt Injection using healthcare-oriented scenarios.

## What This Lab Covers

- Direct and indirect prompt injection attempts
- Instruction hierarchy abuse (system vs user intent)
...
Local URL: `http://localhost:21010`
